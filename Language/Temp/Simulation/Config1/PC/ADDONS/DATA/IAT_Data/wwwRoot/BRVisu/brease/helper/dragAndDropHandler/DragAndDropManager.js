define(['brease/core/Utils', 'brease/events/BreaseEvent', 'brease/events/Gestures', 'brease/helper/dragAndDropHandler/draggable'],
    function (Utils, BreaseEvent, Gestures, Draggable) {

        'use strict';

        /**
        * @class brease.helper.dragDropHandler.DragAndDropManager
