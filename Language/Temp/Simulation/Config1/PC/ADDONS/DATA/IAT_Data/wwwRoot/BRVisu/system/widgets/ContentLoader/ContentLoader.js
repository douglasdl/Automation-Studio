    ...
    function (SuperClass, Enum, BreaseEvent, widgetController, parser, controllerUtils) {
        ...
        */
        ...
        p.onBeforeSuspend = function () {
            //console.log('%c' + this.elem.id + '.onBeforeSuspend(' + this.settings.contentId + ')', 'color:#880');
            _removeListeners.call(this);
            widgetController.walkWidgetsInContent(this.settings.contentId, 'onBeforeSuspend');
        };
        p.suspend = function suspend() {
            //console.log('%c' + this.elem.id + '.suspend(' + this.settings.contentId + ')', 'color:#880');
            //_removeListeners.call(this);
            //widgetController.walkWidgetsInContent(this.settings.contentId, 'onBeforeSuspend');
        ...
        p.suspendedListener = function suspendedListener(e) {
            //console.log(this.elem.id + '.suspendedListener:' + e.detail.contentId, this.settings.contentId);
        ...
        p.disposedListener = function disposedListener(e) {
            //console.log(this.elem.id + '.disposedListener:' + e.detail.contentId, this.settings.contentId);
            if (e.detail.contentId === this.settings.contentId) {
                _removeListeners.call(this);
        ...
        p.unloadListener = function (e) {
            //console.log(this.elem.id + '.unloadListener:' + e.detail.contentId, this.settings.unloadContentId);
        ...
        p.flush = function flush() {
            //console.warn('%c' + this.elem.id + '.flush(' + this.settings.contentId + '),this.isLoaded=' + this.isLoaded, 'color:#cc00cc');
            if (this.isLoaded) {
                ...
                $.when(
                    ...
                    //console.log('activateContent.successHandler:contentId=' + contentId + '/' + widget.settings.contentId);
                        ...
                        if (contentId === widget.settings.contentId) {
                            ...
                            //console.log(widget.elem.id + '.dispatch show');
        ...
        function _unload(contentId, url) {
            //console.log(this.elem.id + '._unload:' + contentId);
        ...
        function _dispatchHide(contentId, url) {
            //console.warn(this.elem.id + '.dispatch ' + BreaseEvent.FRAGMENT_HIDE, { contentId: contentId, url: url });
            this.dispatchEvent(new CustomEvent(BreaseEvent.FRAGMENT_HIDE, { detail: { contentId: contentId, url: url } }));
        }

        function _load() {
            var widget = this;
            //console.log('%c' + this.elem.id + '._load(' + widget.settings.url + ',' + widget.settings.contentId + ')', 'color:blue');
            _clearTimer.call(this);
        ...
        function _activateFinished() {
            var widget = this;
            //console.log(this.elem.id + '._activateFinished:');
            $.when(
