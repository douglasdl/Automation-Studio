define(['brease/config', 'brease/settings', 'brease/core/Utils', 'jquery', 'brease/events/VirtualEvents', 'brease/events/jqueryEvents', 'libs/lodash', 'libs/polyfill', 'brease/services/LoadedByBootstrapper'], 
        ...
        function _start(startMethod, startId, customConfig) {
            ...
            require([servicePath, webSocketPath, 'brease/services/RuntimeService', 'brease/core/libs/Extensions', 'brease/events/BreaseEvent'], function (serviceBridge, webSocket, runtimeService, Extensions, BreaseEvent) {
                ...
                require(files, function (BaseWidget, BaseWidgetExtension) {
                    ...
                    require(['brease/controller/BindingController', 'brease/controller/ConnectionController', 'brease/controller/InfoController', 'brease/controller/ActionController', 'brease/controller/PageController', 'brease/controller/OverlayController', 'brease/controller/UIController', 'brease/helper/NumberFormatter', 'brease/controller/EventController', 'brease/controller/WidgetController', 'brease/controller/KeyboardManager', 'brease/model/VisuModel'], function (bindingController, connectionController, infoController, actionController, pageController, overlayController, uiController, NumberFormatter, eventController, widgetController, keyboardManager, visuData) {
