define(['brease/core/BaseWidget', 'brease/events/BreaseEvent', 'brease/enum/Enum'], function (SuperClass, BreaseEvent, Enum) {
    ...
    */
    ...
    p._enableHandler = function () {
        ...
        selectChildren(this.getContainer()).each(function () {
            if (brease.uiController.getWidgetState(this.id) < Enum.WidgetState.INITIALIZED || brease.uiController.callWidget(this.id, 'setParentEnableState', !disabled) === null) {
                brease.uiController.addWidgetOption(this.id, 'parentEnableState', !disabled);
            }
        });
    };
