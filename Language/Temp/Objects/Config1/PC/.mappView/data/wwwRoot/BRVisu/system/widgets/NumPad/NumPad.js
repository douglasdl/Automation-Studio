        ...
        */
        ...
        p._keyUpHandler = function (e) {
            ...
            if (this.numRegExp.test(value)) {
                this.buttons.triggerButton('value', value);
            } else if (value === ',' || value === '.') {
                this.buttons.triggerButton('comma');
            } else if (value === '-' || value === '+') {
                this.buttons.triggerButton('sign');
            } else if (e.keyCode === 8) {
                this.buttons.triggerButton('delete');
            } else if (e.keyCode === 13) {
                this.buttons.triggerButton('enter');
            }
        ...
        p.loadHTML = function () { 
            ...
            require(['text!' + widget.settings.html], function (html) {
                ...
                var slider = new Slider(widget);
                widget.outputElements.addElement(slider);
                widget.inputElements.addElement(slider);

                var numericOutput = new NumericValue(widget);
                widget.outputElements.addElement(numericOutput);
