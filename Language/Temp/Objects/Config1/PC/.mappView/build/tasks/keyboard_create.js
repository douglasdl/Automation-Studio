...
module.exports = function (grunt) {
    ...
    */
        ...
        _xmlConvert.xml2js(xmlString, {
            ...
            if (xmlObj) {
                ...
                if (keyboardType === 'NumPad') {
                    var cssClassName = widgetObject.qualifiedName.replace(/\//g, '_');
                    // widget html file
                    ...
                    var templateHTML = grunt.file.read(_modulePath.resolve(baseClassObject.dir, baseClassObject.name + '.html')),
                        widgetHTML = _createWidgetHTML(templateHTML, baseClassObject, widgetObject);
                ...
                var classInfo = jsPrepare.run(widgetInfo, widgetObject.qualifiedName, baseClassObject.type, false, { keyboard: widgetObject.keyboardType });
    ...
    function _createWidgetHTML(templateHTML, baseClassObject, widgetObject) {
        var html = templateHTML.replace(baseClassObject.qualifiedName, widgetObject.qualifiedName);
        return html.replace('WIDGETID', 'brease' + widgetObject.baseType);
    }
