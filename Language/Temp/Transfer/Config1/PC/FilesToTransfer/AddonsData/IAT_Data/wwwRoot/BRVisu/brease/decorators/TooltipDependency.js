...
function (Decorator, Utils, BreaseEvent, Enum, PopUpManager, ZoomManager) {
    ...
    */
    ...
    function _positionTooltipContent() {
        ...
        if (offsetFlag) {
            arrowOffset.top = tooltipIndicatorInnerRect.top - tooltipContentArrowRect.height + scrollOffsetY;
            if (tooltipIndicatorInnerRect.top - contentPlusArrowHeight <= 0) {
                this.tooltip.contentArrow.addClass('ontop');
                arrowOffset.top = tooltipIndicatorInnerRect.top + tooltipIndicatorInnerRect.height / 2 + tooltipContentArrowRect.height + scrollOffsetY;
            }
