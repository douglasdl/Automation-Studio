...
function (ServerStub, WebSocketStub, VisuStatus, ErrorCode, ServerEvent) {
    ...
    var testServices = {
            ...
            resetModelData: function () {
                ServerStub.resetModelData();
                WebSocketStub.resetData();
            },
    ...
    return {
        ...
        ***********************/
        ...
        getSessionEventSubscription: function (callback, callbackInfo) {
            ...
            response.eventSubscriptions = ServerStub.getEventSubscriptions();
            callback(response, callbackInfo);
        },
