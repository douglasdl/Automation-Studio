define(['brease/events/BreaseEvent', 'brease/events/ServerEvent', 'brease/core/Utils', 'brease/controller/objects/PageTypes', 'brease/controller/objects/AssignTypes', 'brease/controller/objects/VisuStatus', 'brease/controller/libs/LogCode', 'brease/objects/Content', 'brease/objects/Page', 'brease/objects/AreaInfo', 'brease/objects/Navigation', 'brease/services/LoadedByBootstrapper'],
    function (BreaseEvent, ServerEvent, Utils, PageTypes, AssignTypes, VisuStatus, LogCode, Content, Page, AreaInfo, Navigation, loadedByBootstrapper) {
        ...
        */
        ...
        function _contentsOfPage(pageId, pageType) {
            var contents = [],
                page = (pageType === PageTypes.DIALOG) ? VisuModel.getDialogById(pageId) : VisuModel.getPageById(pageId);
            if (page) {
