define([
    ...
    'widgets/brease/KeyBoard/libs/LayoutSelector', 
    ...
    function _setFocus() {
        var length = this.output[0].value.length;
        this.output[0].setSelectionRange(length, length);
    ...
    function _loadHTMLLayout_responseHandler(htmlPath, html) {
        if (htmlPath === instance.settings.html) {
