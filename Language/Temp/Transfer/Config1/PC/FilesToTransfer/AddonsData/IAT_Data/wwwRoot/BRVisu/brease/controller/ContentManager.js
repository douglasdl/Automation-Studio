    ...
    */
        ...
        var controller = {
                ...
                init: function (runtimeService) {
                    if (_runtimeService) {
                        _runtimeService.removeEventListener(ServerEvent.CONTENT_ACTIVATED, _contentActivatedHandler, true);
                        _runtimeService.removeEventListener(ServerEvent.CONTENT_DEACTIVATED, _contentDeactivatedHandler, true);
                    }
                    _runtimeService = runtimeService;
                    runtimeService.addEventListener(ServerEvent.CONTENT_ACTIVATED, _contentActivatedHandler, true);
                    runtimeService.addEventListener(ServerEvent.CONTENT_DEACTIVATED, _contentDeactivatedHandler, true);
                },
