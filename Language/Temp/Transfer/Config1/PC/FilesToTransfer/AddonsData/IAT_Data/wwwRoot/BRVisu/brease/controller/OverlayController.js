    ...
    */
    ...
    var DialogWindow,
        ...
        controller = {
            ...
            */
            openDialog: function (dialogId, mode, horizontalPos, verticalPos, refContainer, headerText, autoClose) {
                var def = $.Deferred(),
                    options = {};
                ...
                mode = Types.parseValue(mode, 'Enum', { IAT_Enum: Enum.DialogMode, default: defaults.openDialog.mode });
                ...
                if (horizontalPos !== undefined) {
                    ...
                    if (Utils.isString(horizontalPos)) {
                        options.position.horizontal = Types.parseValue(horizontalPos, 'Enum', { IAT_Enum: Enum.HorizontalPosition, default: defaults.openDialog.horizontalPos });
                    } else {
                ...
                if (verticalPos !== undefined) {
                    ...
                    if (Utils.isString(verticalPos)) {
                        options.position.vertical = Types.parseValue(verticalPos, 'Enum', { IAT_Enum: Enum.VerticalPosition, default: defaults.openDialog.verticalPos });
                    } else {
            ...
            */
            openDialogAtTarget: function (dialogId, mode, horizontalPos, verticalPos, refContainer, headerText, autoClose, horDialogAlignment, verDialogAlignment) {
                var def = $.Deferred(),
                    options = {};
                ...
                mode = Types.parseValue(mode, 'Enum', { IAT_Enum: Enum.DialogMode, default: defaults.openDialogAtTarget.mode });
                options.modal = mode === Enum.DialogMode.MODAL;

                options.position = {
                    horizontal: Types.parseValue(horizontalPos, 'Enum', { IAT_Enum: Enum.HorizontalPosition, default: defaults.openDialogAtTarget.horizontalPos }),
                    vertical: Types.parseValue(verticalPos, 'Enum', { IAT_Enum: Enum.VerticalPosition, default: defaults.openDialogAtTarget.verticalPos }),
                    horizontalDialog: Types.parseValue(horDialogAlignment, 'Enum', { IAT_Enum: Enum.HorizontalPosition, default: defaults.openDialogAtTarget.horDialogAlignment }),
                    verticalDialog: Types.parseValue(verDialogAlignment, 'Enum', { IAT_Enum: Enum.VerticalPosition, default: defaults.openDialogAtTarget.verDialogAlignment })
                };
            ...
            closeDialog: function (dialogId) {
                ...
                if (dWindow) {
                    ...
                    $.when(
                        ...
                        document.body.dispatchEvent(new CustomEvent(BreaseEvent.DIALOG_CLOSED, { bubbles: true, cancelable: true, detail: { dialogId: dialogId } }));
                    });
                    dWindow.widget.hide();
