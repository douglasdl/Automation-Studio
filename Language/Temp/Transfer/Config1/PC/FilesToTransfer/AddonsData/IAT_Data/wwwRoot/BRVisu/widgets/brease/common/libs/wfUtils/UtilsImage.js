define([
    ...
    */
    UtilsImage.getInlineSvg = function (sourceImage, avoidBrokenSvg, array) {
        var deferedElement = $.Deferred(),
            brokenSvg = UtilsImage.getBrokenSvg();
        d3.xml(sourceImage).mimeType('image/svg+xml').get(function (error, xml) {
            ...
            } else if (array === undefined || array[array.length - 1] === sourceImage) {
